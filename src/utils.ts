...
import { getCreateACOFactory } from './mappings/ACOFactory'
...
export function getCreateEth(): Asset {
  ...
  if (eth == null) {
    ...
    let assets = acoFactory.assets
    assets.push(eth.id)
    acoFactory.assets = assets
    acoFactory.numAssets = acoFactory.numAssets + BigIntOne
    acoFactory.save()
  }
